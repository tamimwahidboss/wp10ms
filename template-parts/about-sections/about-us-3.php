        ...
        <div class="row">
            <div class="col-xl-5 col-lg-6 col-12">
                <div class="section-title style-3 mb-30">
                    ...
                    <p><?php echo isset( $options['v3-about-span'] ) ? esc_attr( $options['v3-about-span'] ) : ''; ?></p>
                    ...
                    foreach( $repeater_boxes as $repeater_box ) {
                        ...
                        <div class="about-icon-box">
                            ...
                            <div class="content">
                                ...
                                <p><?php echo isset( $repeater_box['v3-about-box-p'] ) ? esc_attr( $repeater_box['v3-about-box-p'] ) : ''; ?></p>
                            </div>
                        </div>
                        <?php
                    }
            ...
            <div class="col-lg-6 col-xl-6 col-12 offset-xl-1">
                <div class="consultations-form style-2 bg-cover" style="background-image: url('<?php echo esc_url( 'assets/img/cs-form-bg.jpg' ); ?>')">
                    <p><?php echo isset( $options['v3-about-form-p'] ) ? esc_attr( $options['v3-about-form-p'] ) : ''; ?></p>
