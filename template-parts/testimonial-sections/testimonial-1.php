                    ...
                    if ( isset( $options['v1-testimonial-rep'] ) && ! empty( $options['v1-testimonial-rep'] ) ) {
                        foreach ( $options['v1-testimonial-rep'] as $repeater_box ) {
                            ...
                            <div class="single-testimonial">
                                ...
                                <h2><?php echo isset( $repeater_box['v1-testimonial-h2'] ) ? wp_kses_post( $repeater_box['v1-testimonial-h2'] ) : ''; ?></h2>
                                <div class="client-info">
                                    ...
                                    <div class="client-bio">
                                        <h3><?php echo isset( $repeater_box['v1-testimonial-h3'] ) ? wp_kses_post( $repeater_box['v1-testimonial-h3'] ) : ''; ?></h3>
                                        <p><?php echo isset( $repeater_box['v1-testimonial-p'] ) ? wp_kses_post( $repeater_box['v1-testimonial-p'] ) : ''; ?></p>
                                    </div>
                                </div>
                            </div>
                            <?php
