                ...
                <div class="row">
                    <div class="col-12 col-xl-8 col-lg-10">
                        <div class="hero-contents">
                            <h2><?php echo isset( $options['v1-hero-h2'] ) ? wp_kses_post( $options['v1-hero-h2'] ) : ''; ?></h2>
                            <h1 class="fs-lg"><?php echo isset( $options['v1-hero-h1'] ) ? wp_kses_post( $options['v1-hero-h1'] ) : ''; ?></h1>
                            <p><?php echo isset( $options['v1-hero-p'] ) ? wp_kses_post( $options['v1-hero-p'] ) : ''; ?></p>
                            <?php
                            if ( isset( $options['v1-hero-btn-rep'] ) && is_array( $options['v1-hero-btn-rep'] ) ) {
                                foreach( $options['v1-hero-btn-rep'] as $repeat ) {
                                    ...
                                    $btn_text = isset( $repeat['v1-hero-btn-text'] ) ? wp_kses_post( $repeat['v1-hero-btn-text'] ) : '';
                                    $btn_icon = isset( $repeat['v1-hero-btn-icon'] ) ? wp_kses_post( $repeat['v1-hero-btn-icon'] ) : '';
                                    ?>
