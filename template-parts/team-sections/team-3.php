        ...
        <div class="row align-items-center mb-40">
            <div class="col-12 col-md-7 text-center text-md-left">
                <div class="section-title">
                    <p><?php echo isset( $options['v3-team-p'] ) ? wp_kses_post( $options['v3-team-p'] ) : ''; ?></p>
                    <h1><?php echo isset( $options['v3-team-h1'] ) ? wp_kses_post( $options['v3-team-h1'] ) : ''; ?></h1>
                </div>
            </div>
            <div class="col-12 col-md-5 mt-4 mt-md-0 text-center text-md-right">
                <a href="<?php echo isset( $options['v3-team-btn']['url'] ) ? esc_url( $options['v3-team-btn']['url'] ) : '#' ; ?>" class="theme-btn">
                    <?php echo isset( $options['v3-team-btn']['text'] ) ? wp_kses_post( $options['v3-team-btn']['text'] ) : 'Button'; ?> 
                    ...
                    <div class="col-12 col-md-6 col-xl-3">
                        <div class="single-member-card">
                            ...
                            <div class="member-bio">
                                <h4><?php echo isset( $repeater_box['v3-team-box-h4'] ) ? wp_kses_post( $repeater_box['v3-team-box-h4'] ) : ''; ?></h4>
                                <p><?php echo isset( $repeater_box['v3-team-box-p'] ) ? wp_kses_post( $repeater_box['v3-team-box-p'] ) : ''; ?></p>
                            </div>
                                ...
                                if ( isset( $repeater_box['v3-team-social-rep'] ) && ! empty( $repeater_box['v3-team-social-rep'] ) ) {
                                    foreach ( $repeater_box['v3-team-social-rep'] as $repeater_social ) {
                                        ...
                                        <a href="<?php echo isset( $repeater_social['v3-team-social-link']['url'] ) ? esc_url( $repeater_social['v3-team-social-link']['url'] ) : '#' ; ?>">
                                            <i class="<?php echo isset( $repeater_social['v3-team-social-icon'] ) ? wp_kses_post( $repeater_social['v3-team-social-icon'] ) : ''; ?>"></i>
                                        </a>
                                        <?php
                                    }
                                }
