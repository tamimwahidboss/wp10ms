...
<section class="hero-slide-wrapper hero-2">
    <div class="hero-slider-2 owl-carousel">
        ...
        foreach( $repeater_boxes as $repeater_box ) {
            ...
            $hero_h1 = isset( $repeater_box['v2-hero-slide-h1'] ) ? wp_kses_post( $repeater_box['v2-hero-slide-h1'] ) : '';
            $hero_p = isset( $repeater_box['v2-hero-slide-p'] ) ? wp_kses_post( $repeater_box['v2-hero-slide-p'] ) : '';
            ?>
                        ...
                        <div class="col-12 col-lg-10 col-xl-8">
                            <div class="hero-contents">
                                ...
                                foreach( $repeater_btns as $repeater_btn ) {
                                    ...
                                    $btn_text = isset( $repeater_btn['v2-hero-btn']['text'] ) ? wp_kses_post( $repeater_btn['v2-hero-btn']['text'] ) : '';
                                    $btn_icon = isset( $repeater_btn['v2-hero-btn-icon'] ) ? wp_kses_post( $repeater_btn['v2-hero-btn-icon'] ) : '';
                                    ?>
